# Imperial imperial-body-avatar

**Cinema-grade GPU worker for the Imperio Nyemen video/avatar pipeline.**

Role: `MimicMotion body avatar`. Built atop `runpod/worker-comfyui:5.8.5-base`.

## Image

```
ghcr.io/mentexdev/imperial-body-avatar:latest
ghcr.io/mentexdev/imperial-body-avatar:v1
```
